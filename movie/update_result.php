...
if(isset($_POST['movieTitle2']) && isset($_POST['movieGenre2'])
&& isset($_POST['movieYear2']) && isset($_POST['moviePrice2'])){
    $title = $_POST["movieTitle2"];
    $genre = $_POST["movieGenre2"];
    $myear = $_POST["movieYear2"];
    $price = $_POST["moviePrice2"];
}
$sql="UPDATE movie SET title='".$title."', genre = '".$genre."',
myear = '".$myear."',price = ".$price." WHERE title = '".$title."'";
